...
namespace ONGR\MonitoringBundle\Tests\Unit;

use ONGR\MonitoringBundle\ONGRMonitoringBundle;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\Finder\Finder;

/**
 * Class ONGRConnectionsBundleTest.
 */
class ONGRMonitoringBundleTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testPassesRegistered()
    {
        ...
        $bundle = new ONGRMonitoringBundle();
